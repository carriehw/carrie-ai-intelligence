...
7. **連續期數唔好將同一條產品／功能線再開新 headline**（Carrie 2026-07-27 feedback）：起草前檢查上一期同上上期嘅標題／連結，同一個產品線（例如「ChatGPT Ads」）如果上期已經開過正選新聞，呢期得返漸進式嘅細更新（加多個功能、擴多個市場、數字微升），**唔好再開一個新 headline**——用 Pattern Watch 或者喺相關新聞嘅 Key Highlights 入面一句帶過就夠。只有出現重大進展（例如由 beta 變公開 GA、市場覆蓋大幅跳升、方向逆轉、被監管介入）先值得重開一個新 headline，並且要喺標題或者首個 bullet 講明「呢個係跟進」（例如「继…之後，再進一步…」），等讀者知道呢個唔係全新獨立新聞
